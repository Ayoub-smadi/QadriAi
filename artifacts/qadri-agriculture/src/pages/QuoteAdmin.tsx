...
export default function QuoteAdmin() {
  ...
  const downloadPdf = async () => {
    ...
    setDownloading(true);
    try {
      const canvas = await html2canvas(sheetRef.current, { scale: 1.5, backgroundColor: "#ffffff", useCORS: true, imageTimeout: 0, logging: false });
      ...
      for (let page = 0; page < pages; page += 1) {
        ...
        pdf.addImage(imageData, "JPEG", margin, imageY, pageWidth, imageHeight, undefined, "FAST");
      }
