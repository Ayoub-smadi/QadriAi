      ...
      <main>
        <section className="relative overflow-hidden border-b border-[#35530e]/10 bg-[#eff3e8]">
          <div
            ...
            style={{
              backgroundImage:
                "radial-gradient(circle at 10% 15%, rgba(255,255,255,.95) 0, transparent 28%), linear-gradient(115deg, rgba(247,250,242,.92), rgba(234,242,225,.18))",
            }}
          />
          <div className="container relative grid min-h-[610px] items-center gap-10 py-12 lg:grid-cols-[.92fr_1.08fr] lg:py-16">
            <div className="order-2 max-w-2xl lg:order-1">
              <div className="inline-flex items-center gap-2 rounded-full border border-[#5d7d30]/18 bg-white/80 px-3 py-1.5 text-xs font-bold text-[#476b19]">
                <span className="size-1.5 rounded-full bg-[#88a849]" />
                {language === "ar"
                  ? "ذكاء زراعي مسؤول، بتوجيه من الخبرة"
                  : "Responsible AI, guided by agricultural expertise"}
              </div>
              <h1 className="mt-6 text-balance text-4xl font-bold leading-[1.16] tracking-tight text-[#29410d] sm:text-5xl lg:text-6xl">
                {language === "ar"
                  ? "مهندس زراعي ذكي بين يديك."
                  : "An intelligent agricultural engineer at your fingertips."}
              </h1>
              <p className="mt-6 max-w-xl text-lg leading-8 text-[#607052]">
                {language === "ar"
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <Button
                  asChild
                  className="h-12 rounded-xl bg-[#35530e] px-5 text-base text-white shadow-[0_12px_24px_rgba(53,83,14,.22)] hover:bg-[#294108]"
                >
                ...
                <Button
                  asChild
                  variant="outline"
                  className="h-12 rounded-xl border-[#35530e]/20 bg-white px-5 text-base text-[#35530e] hover:bg-[#f4f7f0]"
                >
                  <Link href="/engineer">
              ...
              <div className="mt-10 flex flex-wrap gap-x-5 gap-y-3 text-sm font-semibold text-[#5d6b4d]">
                <span className="flex items-center gap-2">
                  <ShieldCheck className="size-4 text-[#66852e]" />
                  {language === "ar" ? "توصيات حذرة" : "Cautious guidance"}
                </span>
                <span className="flex items-center gap-2">
                  <CheckCircle2 className="size-4 text-[#66852e]" />
            ...
            <div className="order-1 lg:order-2">
              <div className="relative mx-auto w-full max-w-[430px]">
                <div className="absolute -inset-4 rounded-[2.25rem] bg-[#6c8b37]/15 blur-2xl" />
        ...
        <section className="container py-12 sm:py-16">
          <div
            className="relative overflow-hidden rounded-[2rem] border border-[#35530e]/10 bg-[#f4f8ee] p-6 shadow-[0_16px_40px_rgba(48,67,22,.07)] sm:p-9"
            dir={language === "ar" ? "rtl" : "ltr"}
          >
            <div className="pointer-events-none absolute -end-16 -top-20 size-48 rounded-full bg-[#dcebbd]/70 blur-3xl" />
            <div className="relative max-w-4xl">
              <p className="text-xs font-bold tracking-[.16em] text-[#759244]">
                {language === "ar" ? "رؤية زراعية من الأردن" : "AN AGRICULTURAL VISION FROM JORDAN"}
              </p>
              <h2 className="mt-2 text-2xl font-bold tracking-tight text-[#293d12] sm:text-3xl">
                {language === "ar" ? "المهندس ثامر القادري" : "Engineer Thamer Al-Qadri"}
              </h2>
              <p className="mt-5 min-h-[11rem] text-base leading-8 text-[#5f6d50] sm:min-h-[8rem]" aria-live="polite">
                {typedBio}
                <span className="ms-1 inline-block font-bold text-[#6d9335] animate-pulse">|</span>
              </p>
              <div className="mt-6 flex flex-wrap gap-3 text-sm font-semibold text-[#496327]">
                ...
                <a href="https://www.alqadrioffers.online" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 rounded-full border border-[#bcd3a1] bg-white/80 px-4 py-2 transition hover:bg-white">
        ...
        <section className="container py-12 sm:py-16">
          <div className="flex flex-col justify-between gap-5 sm:flex-row sm:items-end">
            <div>
              ...
              <h2 className="mt-2 text-3xl font-bold tracking-tight text-[#293d12]">
                {language === "ar" ? "من الملاحظة إلى متابعة ذات معنى" : "From observation to meaningful follow-up"}
              </h2>
            </div>
            <p className="max-w-md text-sm leading-6 text-[#68775a]">
              {language === "ar"
            ...
            {steps.map((step, index) => (
              <div key={step.ar} className="relative text-center">
                {index < steps.length - 1 && (
                  <span className="absolute top-5 start-[61%] hidden h-px w-[78%] bg-[#cfdcc0] md:block" />
                )}
                <span className="relative mx-auto grid size-10 place-items-center rounded-xl bg-[#e9f0df] text-[#35530e] sm:size-12">
                  <step.icon className="size-4 sm:size-5" />
                </span>
                <p className="mt-2 text-xs font-bold text-[#4d5d3b]">
        ...
        <section className="container pb-16">
          <div dir={language === "ar" ? "rtl" : "ltr"} className="relative overflow-hidden rounded-[2rem] bg-[#35530e] p-7 text-white shadow-[0_20px_50px_rgba(53,83,14,.2)] sm:p-10">
            <div className="pointer-events-none absolute -end-10 -top-20 size-56 rounded-full bg-[#84a94b]/30 blur-3xl" />
            <div className="relative grid gap-8 lg:grid-cols-[1.1fr_.9fr] lg:items-center">
              <div>
                ...
                <p className="mt-4 max-w-xl leading-7 text-[#e1ebd0]">
                  {language === "ar"
                ...
                <Button asChild className="mt-6 h-11 rounded-xl bg-white px-5 text-[#35530e] hover:bg-[#eef5e4]">
                  <Link href="/engineer">
              ...
              <div className="rounded-[1.5rem] border border-white/15 bg-white/10 p-5 backdrop-blur-sm">
                <p className="text-xs font-bold tracking-[.14em] text-[#d5e5b8]">
        ...
        <section className="border-y border-[#35530e]/8 bg-white">
          <div className="container py-14 sm:py-20">
            <div className="max-w-2xl">
              <p className="text-xs font-bold tracking-[.16em] text-[#759244]">
                {language === "ar" ? "خدمات موجهة بالفعل" : "PURPOSEFUL SERVICES"}
              </p>
              <h2 className="mt-2 text-3xl font-bold tracking-tight text-[#293d12] sm:text-4xl">
                {language === "ar" ? "كل ما تحتاجه لاتخاذ قرار زراعي أفضل" : "Everything needed for a better agricultural decision"}
              </h2>
            </div>
            <div className="mt-10 grid gap-4 sm:grid-cols-2">
              {services.map((service) => (
                <Link key={service.href} href={service.href} className="group rounded-[1.5rem] border border-[#35530e]/8 bg-white p-5 no-underline shadow-[0_10px_30px_rgba(48,67,22,.05)] transition duration-200 hover:-translate-y-1 hover:shadow-[0_16px_38px_rgba(48,67,22,.1)]">
                  <span className={`grid size-11 place-items-center rounded-xl ${service.tone} text-[#35530e]`}>
                    <service.icon className="size-5" />
                  </span>
                  <h3 className="mt-5 text-lg font-bold text-[#314617]">{service.title}</h3>
                  <p className="mt-2 text-sm leading-6 text-[#68775a]">{service.text}</p>
                  <span className="mt-4 inline-flex items-center gap-1 text-sm font-bold text-[#52731f]">
        ...
        <section className="container py-16">
          <div className="grid gap-6 rounded-[2rem] bg-[#35530e] p-7 text-white shadow-[0_20px_50px_rgba(53,83,14,.2)] sm:p-10 lg:grid-cols-[1.2fr_.8fr] lg:items-center">
            <div>
              <p className="text-xs font-bold tracking-[.16em] text-[#d5e5b8]">
            ...
            <div className="flex justify-start lg:justify-end">
              <Button asChild className="h-12 rounded-xl bg-white px-5 text-[#35530e] hover:bg-[#eef5e4]">
                <Link href="/knowledge">
