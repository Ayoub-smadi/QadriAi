      ...
      <div ref={scrollAreaRef} className="min-h-0 flex-1 overflow-hidden">
        {displayMessages.length === 0 ? (
          <div className="flex h-full flex-col items-center justify-center gap-6 p-4 text-muted-foreground">
            <div className="flex flex-col items-center gap-3 text-center"><img src="/assets/qadri-bot-logo.png" alt="Qadri bot" className="size-16 object-contain" /><p className="text-sm">{emptyStateMessage}</p></div>
           ...
           {message.role === "assistant" && <div className="mt-1 grid size-8 shrink-0 place-items-center rounded-full bg-primary/10 p-1"><img src="/assets/qadri-bot-logo.png" alt="" aria-hidden="true" className="size-full object-contain" /></div>}
         ...
         </div>)}{isLoading && <div className="flex items-start gap-3"><div className="mt-1 grid size-8 shrink-0 place-items-center rounded-full bg-primary/10 p-1"><img src="/assets/qadri-bot-logo.png" alt="" aria-hidden="true" className="size-full object-contain" /></div><div className="rounded-2xl bg-muted px-4 py-3"><Loader2 className="size-4 animate-spin text-muted-foreground" /></div></div>}</div></ScrollArea>}
      </div>
