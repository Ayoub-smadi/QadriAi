...
type CatalogItem = { speciesKey: number; scientificName: string; canonicalName?: string; family?: string; genus?: string; taxonClass?: string; countries: string[]; sourceUrl: string };
...
const catalogStageData = (item: CatalogItem): TreeData => ({
  ...
  sources: [{ label: "GBIF species record", url: item.sourceUrl }],
  imageUrl: "/assets/ai-plant-icon.png",
  growthStages: [
